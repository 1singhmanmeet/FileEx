...
```
	dependencies {
	        compile 'com.github.1singhmanmeet:FileEx:v1.0.5'
	}
...
Create instance of the FileEx class as given below:

```
  // FileEx fileEx=FileEx.newFileManager(<Path to of directorytory thaat you want to open >);
...
```
public Intent getOpenableIntent(String fileName)  // return openable intent which can be directly fired to open file.
public boolean isFile(String name)                // To ccheck wheather the given string is file or directory
public List<String> openDir(String dirName)       // This method open the given directory name and returns the list of contents.
public String getFilePath(String file)            // returns the complete path of given file
public String getCurrentDir()                     // returns current directory
public boolean isExists(String path)              // returns true if the given path is present
